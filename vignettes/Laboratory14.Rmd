...
$$SweetIndex = 6.256242 - 0.002327 Pectin$$
...
$$SweetIndex = 6.2520679 - 0.00231060 Pectin$$
...
In our case there are two $\beta$'s so the prior would take the form:
...
The prior on the variance is an inverse gamma:
